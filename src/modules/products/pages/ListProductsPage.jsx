...
const productStatus = {
  ALL: 'all',
  ENABLED: 'enable',    // Cambiado de 'enabled' a 'enable'
  DISABLED: 'disable',  // Cambiado de 'disabled' a 'disable'
};
              ...
              <div className='flex justify-between items-start mb-3'>
                <div>
                  ...
                  <p className='text-base mt-2'>
                    Stock: {product.stockQuantity} - {formatCurrency(product.currentUnitPrice)}
                  </p>
                </div>
                <span
                  className={`
